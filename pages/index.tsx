...
import mainLogo from "@/asset/banner/mainLogo.png";
import { useRouter } from "next/router";
import { FormattedMessage, useIntl } from "react-intl";
import image from "@/public/icons/image/logo/basparIcon.png";
// import RootLayout from './layout'
export default function Home() {
  const { locales } = useRouter();
  const intl = useIntl();
  const title: string = intl.formatMessage({ id: "page.home.head.title" });
    ...
    <div>
      <Head>
        ...
        <meta
          ...
          content="_LVX29IiP5k4uE7iZwlUVa38QtO66IGSxdLz1aF_mR0"
        />
        {/* <!-- viewport --> */}
