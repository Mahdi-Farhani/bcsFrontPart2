  ...
  return (
    <div className={style.totalBox}>
      <div className={style.chartTitleTotal}>
        <span className={style.chartTitleSpan}>{children}</span>
    ...
    <div>
      <div className={style.mainContentPartOne}>
        <div className={style.statusBox}>
          ...
          <div className={style.statusfooter}>
            <StatusBox title={"Sales"} number={"245k"}>
              <span className={style.statusSalesSpanOne}>
                <SalesChartIcon className={style.salesChartIcon} />
              </span>
            </StatusBox>
            <StatusBox title={"Customers"} number={"12.5k"}>
              <span className={style.statusSalesSpanTwo}>
                <Customer className={style.customerIcon} />
              </span>
            </StatusBox>
            <StatusBox title={"Products"} number={"1.54k"}>
              <span className={style.statusSalesSpanThree}>
                <ProductDashboard className={style.salesChartIcon} />
              </span>
            </StatusBox>
            <StatusBox title={"Revenue"} number={"$88k"}>
              <span className={style.statusSalesSpanFour}>
                <SalesChartIcon className={style.salesChartIcon} />
              </span>
            </StatusBox>
          </div>
      ...
      <div className={style.mainContentPartThree}>
        <div className={style.earningBox}>
          ...
          <p className={style.earningPriceParagraph}>
